...
<section-starting-page>
    ...
    <tip-group>
        <a href="https://blog.jetbrains.com/kotlin/2021/11/kotlin-1-6-0-is-released/" description="Find an overview of the changes in the release blog post" type="start">Kotlin blog</a>
    ...
    <main-group>
        <title>Try new features first and leave feedback</title>
        ...
        <a href="whatsnew16.md#unified-compiler-plugin-abi-with-jvm-and-js-ir-backends" description="Same compiler plugin artifacts for Native and other supported platforms">Unified compiler plugin ABI (Experimental)</a>
